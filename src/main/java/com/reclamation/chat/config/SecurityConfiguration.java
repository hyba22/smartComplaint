...
import com.reclamation.chat.security.*;
import com.reclamation.chat.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers("/api/signup/entreprise").permitAll()
                    .requestMatchers("/api/activate").permitAll()
                    .requestMatchers("/api/account/reset-password/init").permitAll()
                    .requestMatchers("/api/account/reset-password/finish").permitAll()
                    .requestMatchers(HttpMethod.GET, "/api/admin/users/chat/**").authenticated()
                    .requestMatchers(HttpMethod.DELETE, "/api/admin/users/**").authenticated()
                    .requestMatchers("/api/dashboard/**").hasAuthority(AuthoritiesConstants.ADMIN)
