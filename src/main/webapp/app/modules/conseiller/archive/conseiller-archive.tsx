...
import { faEye, faArchive, faCheckCircle } from '@fortawesome/free-solid-svg-icons';
...
const ConseillerArchive = () => {
  ...
  const handleViewDetails = (id: number) => {
    navigate(`/conseiller/reclamations/${id}`);
  };
      ...
      <main className="flex-1 ml-[280px] p-6">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-slate-800">{t('archive.title')}</h1>
          </div>
          <p className="text-slate-600">{t('archive.conseillerArchiveSubtitle')}</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          {loading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-slate-800 mb-2">{t('archive.noArchived')}</h3>
              <p className="text-slate-600">{t('archive.resolvedClosedConseillerWillAppear')}</p>
            </div>
          ) : (
...
export default ConseillerArchive;
