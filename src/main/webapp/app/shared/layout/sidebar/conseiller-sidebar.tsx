...
const ConseillerSidebar = () => {
  ...
  const menuItems = [
    { icon: faGauge, labelKey: 'sidebar.dashboard', path: '/conseiller' },
    { icon: faFileText, labelKey: 'sidebar.reclamations', path: '/conseiller/reclamations' },
    { icon: faExchangeAlt, labelKey: 'sidebar.transferred', path: '/conseiller/transferred' },
    { icon: faComments, labelKey: 'sidebar.messages', path: '/chat' },
    { icon: faArchive, labelKey: 'sidebar.archive', path: '/conseiller/archive' },
    { icon: faCalendar, labelKey: 'sidebar.planning', path: '/conseiller/planning' },
    { icon: faCog, labelKey: 'sidebar.settings', path: '/conseiller/settings' },
  ];
...
export default ConseillerSidebar;
