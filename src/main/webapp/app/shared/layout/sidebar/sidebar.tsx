...
const Sidebar = () => {
  ...
  const dashboardPath = isAdmin ? '/admin' : '/responsable';

  const menuItems = [
    { icon: faGauge, labelKey: 'sidebar.dashboard', path: dashboardPath },
    ...(isAdmin ? [{ icon: faUsers, labelKey: 'sidebar.users', path: '/admin/users' }] : []),
    { icon: faComments, labelKey: 'sidebar.chat', path: '/chat' },
    { icon: faExclamationTriangle, labelKey: 'sidebar.reclamations', path: '/admin/reclamations' },
    { icon: faArchive, labelKey: 'sidebar.archive', path: '/admin/archive' },
    { icon: faFolder, labelKey: 'sidebar.fileManager', path: '/files' },
    { icon: faArrowUp, labelKey: 'sidebar.escalatedRequests', path: '/admin/escalated' },
    { icon: faLock, labelKey: 'sidebar.settings', path: '/admin/settings' },
  ];
